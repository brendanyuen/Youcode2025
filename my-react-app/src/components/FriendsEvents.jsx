  ...
  const friends = [
    {
      ...
      events: [
        { title: 'Walk Park', date: '2025-04-10' },
        { title: 'Skiing Exhibition', date: '2025-04-15' },
      ],
    ...
    { 
      ...
      events: [
        { title: 'Seawall Walk', date: '2025-04-12' },
        { title: 'Grouse Grind Hike', date: '2025-04-20' },
      ],
    ...
    },
    {
      ...
      events: [
        { title: 'Climbing', date: '2025-04-14' },
        { title: 'Snowboard Retreat', date: '2025-04-18' },
      ],
